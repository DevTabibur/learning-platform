...
//       .then((res) => res.json())
//       .then((data) => {
//         alert("Successfully adding library books");
//         e.target.reset();
//       });
//   };
...
//           <h2 className="text-xl font-serif text-accent">Welcome to E-Learning Library</h2>
...
//   const { code, selectClass, subjectName, subjectType, subjectRoutine } = book;
//   return (
//     <>
//       <tr>
