              ...
              <form className="" onSubmit={handleSubmit(onSubmit)}>
                <div className="form-control  w-full max-w-xs">
                  <label className="label">
                    <span className="label-text font-mono">Subject Name*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div className="form-control  w-full max-w-xs">
                  <label className="label">
                    <span className="label-text font-mono">Subject Type*</span>
                  </label>
                  <select
                    defaultValue={"DEFAULT"}
                    className="select select-bordered"
                ...
                <div className="form-control  w-full max-w-xs">
                  <label className="label">
                    <span className="label-text font-mono">Select Class*</span>
                  </label>
                  <select
                    defaultValue={"DEFAULT"}
                    className="select select-bordered"
...
const ShowSubjectList = ({ sub }) => {
  const { code, selectClass, subjectName, subjectType, subjectRoutine} =
    sub;
  return (
    <>
      <tr>
